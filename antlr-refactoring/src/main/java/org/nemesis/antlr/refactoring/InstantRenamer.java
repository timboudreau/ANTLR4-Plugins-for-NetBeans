...
public interface InstantRenamer {
     ...
     */
    boolean isRenameAllowed(@NonNull Parser.Result info, int caretOffset, @NullAllowed String[] explanationRetValue);
     ...
     */
    @CheckForNull
    Set<IntRange> getRenameRegions(@NonNull Parser.Result info, int caretOffset);
}
