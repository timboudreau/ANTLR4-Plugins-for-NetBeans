 ...
 */
@FunctionalInterface
public interface DocumentSupplier<T, E extends Exception> {

    T get() throws E, BadLocationException;

    public interface Simple<T> extends DocumentSupplier<T, RuntimeException> {

    }

    static <T> T runNonThrowing(Consumer<Runnable> r, DocumentSupplier<T, RuntimeException> supp) throws BadLocationException {
        return supp.run(r);
    }

    static <T, E extends Exception> T run(Consumer<Runnable> r, DocumentSupplier<T, E> supp) throws E, BadLocationException {
        return supp.run(r);
    }
