...
public class LongArrayBitSet implements AutoCloseable {
    ...
    private LongArrayBitSet(long[] words) {
        this(words, UnsafeLongArray::new);
    }

    private LongArrayBitSet(long[] words, LongFunction<LongArray> arrayFactory) {
        this.arrayFactory = arrayFactory;
        this.words = arrayFactory.apply(words.length);
    ...
    private void sanityCheck() {
        assert (wordsInUse == 0 || word(wordsInUse - 1) != 0) : "wordsInUse: " + wordsInUse;
