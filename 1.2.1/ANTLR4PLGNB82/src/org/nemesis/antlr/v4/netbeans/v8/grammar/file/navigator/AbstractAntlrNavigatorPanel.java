 ...
 * @author Tim Boudreau
 */
public abstract class AbstractAntlrNavigatorPanel<R> implements NavigatorPanel {
    ...
    private static final String PACKAGE_IMAGE_PATH = "org/nemesis/antlr/v4/netbeans/v8/grammar/file/navigator/";
    ...
    protected static ImageIcon alternativeIcon() {
        if (alternativeIcon != null) {
            return alternativeIcon;
        }
        return alternativeIcon = ImageUtilities.loadImageIcon(PACKAGE_IMAGE_PATH + ALTERNATIVE_PNG, false);
    }
}
