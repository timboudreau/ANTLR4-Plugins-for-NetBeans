 ...
 * @author Tim Boudreau
 */
final class IsolationClassLoader<T extends ClassLoader & ExposedFindClass & Closeable> extends ClassLoader implements AutoCloseable, Closeable, Supplier<IsolationClassLoader<?>> {
