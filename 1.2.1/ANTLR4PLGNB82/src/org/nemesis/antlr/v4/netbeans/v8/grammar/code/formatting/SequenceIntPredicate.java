 ...
 * @author Tim Boudreau
 */
public final class SequenceIntPredicate implements ResettableCopyableIntPredicate {
    ...
    SequenceIntPredicate(SequenceIntPredicate parent, int val) {
        this(parent, Debug.predicate(val));
    }
    ...
    public static SequenceIntPredicate matchingAnyOf(int val, int... moreVals) {
        return new SequenceIntPredicate(Debug.predicate(val, moreVals));
    }
    ...
    public SequenceIntPredicate then(int val) {
        return new SequenceIntPredicate(this, Debug.predicate(val));
    }
    ...
    public SequenceIntPredicate then(int val, int... moreVals) {
        return new SequenceIntPredicate(this, Debug.predicate(val, moreVals));
    }
    ...
    private static class ArrayPredicate implements IntPredicate {
        ...
        public ArrayPredicate(int[] vals, boolean negated) {
            this.vals = vals;
        ...
        public IntPredicate negate() {
            return new ArrayPredicate(vals, true);
        }
