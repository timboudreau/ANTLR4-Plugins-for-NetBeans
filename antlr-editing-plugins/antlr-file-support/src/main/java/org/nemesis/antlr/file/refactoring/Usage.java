...
class Usage extends AbstractRefactoringContext implements ComparableRefactoringElementImplementation {
    ...
    Usage(FileObject file, IntRange<? extends IntRange> range, String of, String name, Object... lookupContents) {
        this.file = file;
        this.range = range;
        this.of = of;
        this.name = name;
    ...
    public String getText() {
        return isRef()
                ? Bundle.reference(of, name, range.start(), range.end(), file.getNameExt())
                : Bundle.usage(of, name, range.start(), range.end(), file.getNameExt());
    }
