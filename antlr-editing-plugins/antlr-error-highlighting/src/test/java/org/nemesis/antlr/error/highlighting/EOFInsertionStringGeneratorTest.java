...
public class EOFInsertionStringGeneratorTest {
    ...
    public void testGenLexerRuleName() {
        assertEquals("Syntax", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("syntax"));
        assertEquals("Foooood", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("foOoOoD"));
        assertEquals("Q", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("'q'"));
        assertEquals("Q", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("q"));
        assertEquals("Backslash", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("\\"));
        assertEquals("Slash", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("/"));
        assertEquals("Pipe", AntlrRuntimeErrorsHighlighter.generateLexerRuleName("|"));
    }
