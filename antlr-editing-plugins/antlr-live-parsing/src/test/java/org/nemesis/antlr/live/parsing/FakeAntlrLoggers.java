...
public final class FakeAntlrLoggers extends AntlrLoggers {
    ...
    private UnclosablePrintStream ps = new UnclosablePrintStream(out);
    private Writer w = new UnclosableWriter(out, UTF_8);
    ...
    public static void reset() {
        ...
        INSTANCE.out = new ByteArrayOutputStream();
        INSTANCE.ps = new UnclosablePrintStream(INSTANCE.out);
        INSTANCE.w = new UnclosableWriter(INSTANCE.out, UTF_8);
    }

    public static String output() {
        return INSTANCE == null ? "no instance" : INSTANCE.get();
    }
