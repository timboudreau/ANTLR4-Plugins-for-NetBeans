 ...
 * @author Tim Boudreau
 */
@ServiceProvider(service=TrackingRoots.class, position=200)
public class DebugLeaks implements TrackingRoots {

    @Override
    public void collect(BiConsumer<String, Object> nameAndObject) {
        nameAndObject.accept("AntlrGenerationSubscriptionsImpl singleton", AntlrGenerationSubscriptionsImpl.instance());
    }
