...
match_block : LeftBrace 
    (first=match_case (Comma more=match_case)*)?
...
function_spec : doc=doc_comment? attrs=outer_attribute* vis=visibility? Fn name=function_name lifetimes=lifetime_spec? LeftParen params=parameter_list? RightParen return_type?;
function_name : Ident;
...
struct:
    (doc=doc_comment? outer_attribute* Struct name=Ident lifetimes=lifetime_spec? LeftBrace (struct_item (Comma struct_item)* Comma?)? RightBrace) # PlainStruct
...
comparison_operator : DoubleEquals | LessThanOrEquals | GreaterThanOrEquals | LeftAngleBracket | RightAngleBracket
                    | NotEquals;
...
assignment_operator : Equals | AssignMultiply | AssignDivide | AssignMod | AssignPlus
    | AssignMinus | AssignAnd | AssignOr | AssignShiftLeft | AssignShiftRight;

// unit_type : '()';

intrinsic_type : I8 | I16 | I32 | I64 | I128 | ISIZE | F32 | F64 | U8 | U16 | U32 | U64 | U128 | USIZE | Char | Bool;
