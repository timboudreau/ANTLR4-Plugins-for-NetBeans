...
/**
 * Register an Antlr-based language, generating all necessary configuration
 * and implementation classes for a basic implementation of language support
...
//    boolean permissiveLexer() default true;
    ...
    /**
     * Breif sample text in the language in question.  If set it will be used
     * in the <b>Fonts and Colors</b> options dialog page for your language.
     *
    ...
    /**
     * If present, generate a NetBeans parser using the Antlr parser this
     * field specifies, and which will run any Extractors registered against
     * your file's mime type.
     *
    ...
    public @interface ParserControl {
         ...
         * what class and parser method is the entry point, and <i>must</i> be the type
         * any registered ExtractorRegistrations expect.  This should be the ID of the
         * Antlr parser rule which defines an entire file or compilation unit in the
         * language;  conventionally, this is the first rule in the grammar file, so
         * the default is 0.
         *
         * @return The rule id
         */
        ...
        /**
         * The parser helper need not be defined, but allows you to
         * hook into the lifecycle of each parse and configure the
         * parser, or perform syntactic error analysis or similar,
         * programmatically.
         *
        ...
        /**
         * If true, the generated NetBeans parser class will have a static method
         * that causes all non-garbage-collected parsers to fire a change
         * event, forcing a reparse.  This is only useful for languages which
         * have global configuration (such as PHP) which can affect how the language
         * is parsed, what is or isn't an error, etc.  If you are dealing with such
         * a language, return true here and listen on whatever file or settings
         * affect parsing, and call the generated global reparse method when
         ...
         * example, routing comments or whitespace to a different channel, rather
         * than having every parser rule define every possible location of whitespace
         * or comments).  Antlr parsers generally want only the channel with content
         * relevant to them passed.  This is typically channel 0, but can be set
         * otherwise here.
         *
    ...
    /**
     * If set, generate a DataObject class and register a file type in
     * the IDE for this language (generally you want this unless you are
     * dealing with any language that can be saved to disk, but for advanced
     * cases you may want to implement the DataObject type by hand).
     *
    ...
    public @interface FileType {
        ...
        /**
         * A / delimited path in the JAR to the icon to use for your
         * file type.
         *
         * @return
         */
        ...
        /**
         * If this method returns true, multiple editor views will be
         * possible, and your or other modules can register additional
         * "views" which appear as tab-buttons above the editor.
         *
        ...
        /**
         * This module defines a default set of actions on the generated
         * file type.  You can exclude some of those by including them here -
         * the array entries should be combination of category/action-id, e.g.
