...
public enum KnownTypes implements TypeName {
    ...
    ANTLR_CONFIGURATION_IMPLEMENTATION(
        ...
        Libraries.HELPERS),
    ANTLR_CONSTANTS("org.nemesis.antlr.common.AntlrConstants", Libraries.COMMON),
    ...
    COMPLETIONS_BUILDER("org.nemesis.antlr.completion.CompletionsBuilder",
        Libraries.CODE_COMPLETION),
    COMPLETION_BUILDER("org.nemesis.antlr.completion.CompletionBuilder",
        Libraries.CODE_COMPLETION),
    COMPLETION_ITEM("org.netbeans.spi.editor.completion.CompletionItem",
        Libraries.EDITOR_COMPLETION),
    COMPLETION_ITEM_PROVIDER(
        "org.nemesis.antlr.completion.CompletionItemProvider",
        Libraries.CODE_COMPLETION),
    COMPLETION_PRIORITIES("org.nemesis.antlr.completion.CompletionPriorities",
        Libraries.CODE_COMPLETION),
    ...
    DOCUMENT_ADAPTER_REGISTRY("org.nemesis.source.spi.DocumentAdapterRegistry",
        Libraries.INPUT),
    DOCUMENT_EDIT_BAG("org.nemesis.antlr.spi.language.fix.DocumentEditBag",
        Libraries.ANTLR_LANGUAGE),
    DOCUMENT_EDIT_SET("org.nemesis.antlr.spi.language.fix.DocumentEditSet",
        Libraries.ANTLR_LANGUAGE),
    DOCUMENT_LISTENER_PRIORITY(
        "org.netbeans.lib.editor.util.swing.DocumentListenerPriority",
        Libraries.EDITOR_UTIL),
    DOCUMENT_OPERATION("org.nemesis.editor.utils.DocumentOperation",
        Libraries.UTILS),
    DOCUMENT_OPERATION_BUILDER(
        "org.nemesis.editor.utils.DocumentOperationBuilder", Libraries.UTILS),
    DOCUMENT_OPERATOR("org.nemesis.editor.utils.DocumentOperator",
        Libraries.UTILS),
    DOCUMENT_PROCESSOR("org.nemesis.editor.utils.DocumentProcessor",
        Libraries.UTILS),
    ...
    FINISHABLE_COMPLETIONS_BUILDER(
        "org.nemesis.antlr.completion.CompletionsBuilder.FinishableCompletionsBuilder",
        Libraries.CODE_COMPLETION),
    ...
    FIX_CONSUMER("org.nemesis.antlr.spi.language.fix.FixConsumer",
        Libraries.ANTLR_LANGUAGE),
    FIX_IMPLEMENTATION("org.nemesis.antlr.spi.language.fix.FixImplementation",
        Libraries.ANTLR_LANGUAGE),
    ...
    INSERT_ACTION("org.nemesis.antlr.completion.annos.InsertAction",
        Libraries.CODE_COMPLETION),
    INSERT_POLICY("org.nemesis.antlr.completion.annos.InsertPolicy",
        Libraries.CODE_COMPLETION),
    ...
    INSTANT_RENAME_ACTION_BUILDER(
        ...
        Libraries.RENAME),
    INT_BI_CONSUMER("com.mastfrog.function.IntBiConsumer", Libraries.WRAPPER),
    INT_BI_PREDICATE("com.mastfrog.function.IntBiPredicate", Libraries.WRAPPER),
    ...
    IO_BI_FUNCTION("com.mastfrog.function.throwing.io.IOBiFunction",
        Libraries.WRAPPER),
    ...
    NAME_AND_OFFSETS("org.nemesis.extraction.NameAndOffsets",
        Libraries.EXTRACTION),
    NAME_COMPLETION("org.nemesis.antlr.completion.annos.NameCompletion",
        Libraries.CODE_COMPLETION),
    ...
    RULES_AND_TOKENS_COMPLETIONS(
        "org.nemesis.antlr.language.code.completion.RulesAndTokensCompletions",
    ...
    SERVICE_PROVIDERS("org.openide.util.lookup.ServiceProviders",
        Libraries.LOOKUP),
    SIMPLE_DOCUMENT_UPDATER(
        "org.nemesis.antlr.completion.SimpleDocumentUpdater",
        Libraries.CODE_COMPLETION),
    ...
    SIMPLE_IMPORTERS_FINDER(
        ...
        Libraries.REFACTORING),
    SIMPLE_LANGUAGE_LEXER("org.nemesis.simple.language.SimpleLanguageLexer",
        Libraries.TEST_LANGUAGE),
    SIMPLE_LANGUAGE_PARSER("org.nemesis.simple.language.SimpleLanguageParser",
        Libraries.TEST_LANGUAGE),
    ...
    TOKEN_MATCH("org.nemesis.antlr.completion.TokenMatch",
        Libraries.CODE_COMPLETION),
    TOKEN_MODIFICATION("org.nemesis.antlr.completion.annos.TokenModification",
        Libraries.CODE_COMPLETION),
    TOKEN_PATTERN_BUILDER("org.nemesis.antlr.completion.TokenPatternBuilder",
        Libraries.CODE_COMPLETION),
