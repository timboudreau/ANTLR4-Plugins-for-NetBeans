...
public enum KnownTypes implements TypeName {
    ...
    ABSTRACT_ANTLR_TREE_NAVIGATOR_PANEL(
        ...
        Libraries.NAVIGATORS),
    ABSTRACT_CACHE_MAINTAINER(
        "org.nemesis.antlr.subscription.AbstractCacheMaintainer",
    ...
    CACHE_FILE_WRITER("org.nemesis.antlr.common.cachefile.CacheFileWriter",
        Libraries.ANTLR_COMMON),
    CACHE_MAINTAINER("org.nemesis.antlr.subscription.CacheMaintainer",
        Libraries.ANTLR_COMMON),
    ...
    INSTANT_RENAME_ACTION_BUILDER(
        ...
        Libraries.RENAME),
    INT("com.mastfrog.function.state.Int", Libraries.WRAPPER),
    ...
    QUAD_CONSUMER("com.mastfrog.function.QuadConsumer", Libraries.WRAPPER),
    ...
    TEXT_CELL_LABEL("org.nemesis.swing.cell.TextCellLabel",
        Libraries.SWING_UTILS),
    THREAD_MAPPED_STD_IO("org.nemesis.antlr.stdio.ThreadMappedStdIO",
        Libraries.ANTLR_COMMON),
