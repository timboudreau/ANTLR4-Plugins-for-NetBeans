...
public enum Libraries implements Library {
    ...
    COMMON("org.netbeans.api", "org-netbeans-api-annotations-common",
        "RELEASE113"),
    ANT("com.mastfrog", "antlr-project-helpers-ant", "2.0.51"),
    ANTLR_LANGUAGE("com.mastfrog", "antlr-language-spi", "2.0.51"),
    REFACTORING("com.mastfrog", "antlr-refactoring", "2.0.51"),
    UTILS("com.mastfrog", "antlr-utils", "2.0.51"),
    ANTLR_WRAPPER("com.mastfrog", "antlr-wrapper", "2.0.51"),
    ...
    COMPLETION("com.mastfrog", "antlr-code-completion-spi", "2.0.51"),
    ANTLR_COMMON("com.mastfrog", "antlr-common", "2.0.51"),
    CODE_COMPLETION("com.mastfrog", "antlr-code-completion", "2.0.51"),
    ...
    EXTRACTION("com.mastfrog", "extraction", "2.0.51"),
    FEATURES("com.mastfrog", "editor-features", "2.0.51"),
    FILESYSTEMS("org.netbeans.api", "org-openide-filesystems", "RELEASE113"),
    FILTERS("com.mastfrog", "character-filters", "2.0.51"),
    FOLD("org.netbeans.api", "org-netbeans-modules-editor-fold", "RELEASE113"),
    FOLDING("com.mastfrog", "antlr-code-folding", "2.0.51"),
    FORMATTERS("com.mastfrog", "antlr-formatters", "2.0.51"),
    FORMATTING("com.mastfrog", "antlr-language-formatting", "2.0.51"),
    UI("com.mastfrog", "antlr-language-formatting-ui", "2.0.51"),
    HELPERS("com.mastfrog", "antlr-project-helpers", "2.0.51"),
    HIGHLIGHTING("com.mastfrog", "antlr-highlighting", "2.0.51"),
    ...
    INDEXING("org.netbeans.api", "org-netbeans-modules-parsing-indexing",
        "RELEASE113"),
    INPUT("com.mastfrog", "antlr-input", "2.0.51"),
    ...
    LOCALIZERS("com.mastfrog", "localizers", "2.0.51"),
    ...
    MIMELOOKUP("org.netbeans.api", "org-netbeans-modules-editor-mimelookup",
        "RELEASE113"),
    MODELS("com.mastfrog", "extraction-data-models", "2.0.51"),
    ...
    NAVIGATORS("com.mastfrog", "antlr-navigators", "2.0.51"),
    ...
    OPTIONS_EDITOR("org.netbeans.modules", "org-netbeans-modules-options-editor",
        "RELEASE113"),
    PARSER("com.mastfrog", "tiny-ebnf-parser", "2.0.51"),
    ...
    REFACTORING_COMMON("com.mastfrog", "antlr-refactoring-common", "2.0.51"),
    RENAME("com.mastfrog", "antlr-instant-rename", "2.0.51"),
    RESOLVER("com.mastfrog", "antlr-grammar-file-resolver", "2.0.51"),
    RUNTIME("org.antlr", "antlr-runtime", "3.5.2"),
    SETTINGS("org.netbeans.api", "org-netbeans-modules-editor-settings",
        "RELEASE113"),
    SUPPORT("com.mastfrog", "antlr-file-support", "2.0.51"),
    SWING_UTILS("com.mastfrog", "swing-utils", "2.0.51"),
    TEST_LANGUAGE("com.mastfrog", "simple-test-language", "2.0.51"),
    ...
    EDITOR_UTIL("org.netbeans.api", "org-netbeans-modules-editor-util",
        "RELEASE113"),
    EDITOR_UTILS("com.mastfrog", "editor-utils", "2.0.51"),
    WINDOWS("org.netbeans.api", "org-openide-windows", "RELEASE113"),
    WRAPPER("com.mastfrog", "mastfrog-utils-wrapper", "2.0.51")
    ;
