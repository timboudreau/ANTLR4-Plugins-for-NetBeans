...
public enum Libraries implements Library {
    ...
    COMMON("org.netbeans.api", "org-netbeans-api-annotations-common",
        "RELEASE113"),
    ANT("com.mastfrog", "antlr-project-helpers-ant", "2.0.87"),
    ANTLR_LANGUAGE("com.mastfrog", "antlr-language-spi", "2.0.87"),
    REFACTORING("com.mastfrog", "antlr-refactoring", "2.0.87"),
    UTILS("com.mastfrog", "antlr-utils", "2.0.87"),
    ANTLR_WRAPPER("com.mastfrog", "antlr-wrapper", "2.0.87"),
    ...
    COMPLETION("com.mastfrog", "antlr-code-completion-spi", "2.0.87"),
    ANTLR_COMMON("com.mastfrog", "antlr-common", "2.0.87"),
    CODE_COMPLETION("com.mastfrog", "antlr-code-completion", "2.0.87"),
    CORE("com.mastfrog", "code-completion-core", "2.0.87"),
    ...
    EXTRACTION("com.mastfrog", "extraction", "2.0.87"),
    FEATURES("com.mastfrog", "editor-features", "2.0.87"),
    FILESYSTEMS("org.netbeans.api", "org-openide-filesystems", "RELEASE113"),
    FILTERS("com.mastfrog", "character-filters", "2.0.87"),
    FOLD("org.netbeans.api", "org-netbeans-modules-editor-fold", "RELEASE113"),
    FOLDING("com.mastfrog", "antlr-code-folding", "2.0.87"),
    FORMATTERS("com.mastfrog", "antlr-formatters", "2.0.87"),
    FORMATTING("com.mastfrog", "antlr-language-formatting", "2.0.87"),
    UI("com.mastfrog", "antlr-language-formatting-ui", "2.0.87"),
    HELPERS("com.mastfrog", "antlr-project-helpers", "2.0.87"),
    HIGHLIGHTING("com.mastfrog", "antlr-highlighting", "2.0.87"),
    ...
    INDEXING("org.netbeans.api", "org-netbeans-modules-parsing-indexing",
        "RELEASE113"),
    INPUT("com.mastfrog", "antlr-input", "2.0.87"),
    ...
    LOCALIZERS("com.mastfrog", "localizers", "2.0.87"),
    ...
    MIMELOOKUP("org.netbeans.api", "org-netbeans-modules-editor-mimelookup",
        "RELEASE113"),
    MODELS("com.mastfrog", "extraction-data-models", "2.0.87"),
    ...
    NAVIGATORS("com.mastfrog", "antlr-navigators", "2.0.87"),
    ...
    OPTIONS_EDITOR("org.netbeans.modules", "org-netbeans-modules-options-editor",
        "RELEASE113"),
    PARSER("com.mastfrog", "tiny-ebnf-parser", "2.0.87"),
    ...
    REFACTORING_COMMON("com.mastfrog", "antlr-refactoring-common", "2.0.87"),
    RENAME("com.mastfrog", "antlr-instant-rename", "2.0.87"),
    RESOLVER("com.mastfrog", "antlr-grammar-file-resolver", "2.0.87"),
    RUNTIME("org.antlr", "antlr-runtime", "3.5.2"),
    SETTINGS("org.netbeans.api", "org-netbeans-modules-editor-settings",
        "RELEASE113"),
    SUPPORT("com.mastfrog", "antlr-file-support", "2.0.87"),
    SWING_UTILS("com.mastfrog", "swing-utils", "2.0.87"),
    ...
    EDITOR_UTIL("org.netbeans.api", "org-netbeans-modules-editor-util",
        "RELEASE113"),
    EDITOR_UTILS("com.mastfrog", "editor-utils", "2.0.87"),
    WINDOWS("org.netbeans.api", "org-openide-windows", "RELEASE113"),
    WRAPPER("com.mastfrog", "mastfrog-utils-wrapper", "2.0.87")
    ;
