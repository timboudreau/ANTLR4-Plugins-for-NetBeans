...
public enum Libraries implements Library {
    ...
    COMMON("org.netbeans.api", "org-netbeans-api-annotations-common",
        "RELEASE113"),
    ANTLR_LANGUAGE("com.mastfrog", "antlr-language-spi", "2.0.44"),
    REFACTORING("com.mastfrog", "antlr-refactoring", "2.0.44"),
    UTILS("com.mastfrog", "antlr-utils", "2.0.44"),
    ANTLR_WRAPPER("com.mastfrog", "antlr-wrapper", "2.0.44"),
    API("org.netbeans.contrib.yenta", "api", "1.1"),
    AWT("org.netbeans.api", "org-openide-awt", "RELEASE113"),
    COMPLETION("com.mastfrog", "antlr-language-code-completion", "2.0.44"),
    ANTLR_COMMON("com.mastfrog", "antlr-common", "2.0.44"),
    CODE_COMPLETION("com.mastfrog", "antlr-code-completion", "2.0.44"),
    ...
    EDITOR_UTILS("com.mastfrog", "editor-utils", "2.0.44"),
    EXTRACTION("com.mastfrog", "extraction", "2.0.44"),
    FEATURES("com.mastfrog", "editor-features", "2.0.44"),
    FILESYSTEMS("org.netbeans.api", "org-openide-filesystems", "RELEASE113"),
    FILTERS("com.mastfrog", "character-filters", "2.0.44"),
    FOLD("org.netbeans.api", "org-netbeans-modules-editor-fold", "RELEASE113"),
    FOLDING("com.mastfrog", "antlr-code-folding", "2.0.44"),
    FORMATTERS("com.mastfrog", "antlr-formatters", "2.0.44"),
    FORMATTING("com.mastfrog", "antlr-language-formatting", "2.0.44"),
    UI("com.mastfrog", "antlr-language-formatting-ui", "2.0.44"),
    HELPERS("com.mastfrog", "antlr-project-helpers", "2.0.44"),
    HIGHLIGHTING("com.mastfrog", "antlr-highlighting", "2.0.44"),
    ...
    INDEXING("org.netbeans.api", "org-netbeans-modules-parsing-indexing",
        "RELEASE113"),
    INPUT("com.mastfrog", "antlr-input", "2.0.44"),
    ...
    LOCALIZERS("com.mastfrog", "localizers", "2.0.44"),
    ...
    MIMELOOKUP("org.netbeans.api", "org-netbeans-modules-editor-mimelookup",
        "RELEASE113"),
    MODELS("com.mastfrog", "extraction-data-models", "2.0.44"),
    ...
    NAVIGATORS("com.mastfrog", "antlr-navigators", "2.0.44"),
    ...
    OPTIONS_EDITOR("org.netbeans.modules", "org-netbeans-modules-options-editor",
        "RELEASE113"),
    PARSER("com.mastfrog", "tiny-ebnf-parser", "2.0.44"),
    ...
    REFACTORING_COMMON("com.mastfrog", "antlr-refactoring-common", "2.0.44"),
    RENAME("com.mastfrog", "antlr-instant-rename", "2.0.44"),
    RESOLVER("com.mastfrog", "antlr-grammar-file-resolver", "2.0.44"),
    RUNTIME("org.antlr", "antlr-runtime", "3.5.2"),
    SETTINGS("org.netbeans.api", "org-netbeans-modules-editor-settings",
        "RELEASE113"),
    SUPPORT("com.mastfrog", "antlr-file-support", "2.0.44"),
    TEST_LANGUAGE("com.mastfrog", "simple-test-language", "2.0.44"),
    ...
    EDITOR_UTIL("org.netbeans.api", "org-netbeans-modules-editor-util",
        "RELEASE113"),
    SWING_UTILS("com.mastfrog", "swing-utils", "2.0.44"),
    WINDOWS("org.netbeans.api", "org-openide-windows", "RELEASE113"),
    WRAPPER("com.mastfrog", "mastfrog-utils-wrapper", "2.0.44")
    ;
