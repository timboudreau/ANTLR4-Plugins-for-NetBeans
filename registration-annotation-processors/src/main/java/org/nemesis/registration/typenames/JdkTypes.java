...
public enum JdkTypes implements TypeName {
    ...
    FORK_JOIN_POOL("java.util.concurrent.ForkJoinPool"),
    FUTURE("java.util.concurrent.Future"),
    SCHEDULED_EXECUTOR_SERVICE("java.util.concurrent.ScheduledExecutorService"),
    SCHEDULED_FUTURE("java.util.concurrent.ScheduledFuture"),
    ...
    INT_SUPPLIER("java.util.function.IntSupplier"),
