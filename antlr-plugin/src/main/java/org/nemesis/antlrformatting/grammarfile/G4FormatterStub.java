...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.BEGIN_ARGUMENT;
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.CATCH;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.DOC_COMMENT;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.END_ARGUMENT;
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.FINALLY;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.FRAGMENT;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.HEADER;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.MEMBERS;
...
import static org.nemesis.antlr.v4.netbeans.v8.grammar.code.checking.impl.ANTLRv4Lexer.TOKENS;
...
import static org.nemesis.antlrformatting.api.SimpleFormattingAction.INDENT;
...
import static org.nemesis.antlrformatting.api.SimpleFormattingAction.PREPEND_NEWLINE_AND_DOUBLE_INDENT;
...
import static org.nemesis.antlrformatting.grammarfile.AntlrCounters.COLON_POSITION;
 ...
 * @author Tim Boudreau
 */
@AntlrFormatterRegistration(mimeType="text/g4")
public class G4FormatterStub implements AntlrFormatterStub<AntlrCounters, ANTLRv4Lexer> {
    ...
    static void state(LexingStateBuilder<AntlrCounters, ?> bldr, Preferences config) {
    ...
    static FormattingRules rules(FormattingRules rules, Preferences prefs) {
        AntlrFormatterSettings config = new AntlrFormatterSettings(prefs);
        ...
        rules.onTokenType(ID)
                ...
                .format(PREPEND_SPACE.wrappingLines(COLON_POSITION, 80));
        ...
        if (config.getNewlineStyle().isDoubleNewline()) {
            rules.onTokenType(SEMI)
                    ...
                    .when(AntlrCounters.SEMICOLON_COUNT).isGreaterThan(1)
                    .formatIf(config.getNewlineStyle() == AntlrFormatterSettings.NewlineStyle.IF_COMPLEX, APPEND_DOUBLE_NEWLINE);
        ...
        rules.onTokenType(TOKEN_ID, PARSER_RULE_ID, FRAGDEC_ID, ID)
                ...
                .format(
                        PREPEND_SPACE.wrappingLines(COLON_POSITION, config.getWrapPoint()));
...
//                    int amt = ctx.get("lc", config.getIndentSize());
    ...
    private static final boolean splitOrs = false;
