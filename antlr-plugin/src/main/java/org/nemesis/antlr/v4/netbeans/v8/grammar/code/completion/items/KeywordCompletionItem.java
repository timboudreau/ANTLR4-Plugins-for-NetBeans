    ...
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
          ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
           "/keywordIcon.png"));
    protected static Color color = Color.decode("0x000099");
    
    public KeywordCompletionItem
            (String  text                       ,
             int     insertionOffset            ,
             int     caretOffset                ,
             boolean extraWhitespaceAlreadyThere) {
        super(text, insertionOffset, caretOffset, extraWhitespaceAlreadyThere);
//        System.out.println("KeyworkCompletionItem:KeyworkCompletionItem(String, int) : begin");
//        System.out.println("KeyworkCompletionItem:KeyworkCompletionItem(String, int) : end");
    }
