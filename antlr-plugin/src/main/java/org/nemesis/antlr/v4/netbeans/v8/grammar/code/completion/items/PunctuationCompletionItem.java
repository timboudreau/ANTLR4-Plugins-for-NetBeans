 ...
 */
public class PunctuationCompletionItem extends GrammarCompletionItem {
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
          ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
           "/punctuationIcon.png"));
    protected static Color color = Color.decode("0x000000");
    
    public PunctuationCompletionItem
            (String  text                       ,
             int     insertionOffset            ,
             int     caretOffset                ,
             boolean extraWhitespaceAlreadyThere) {
        super(text, insertionOffset, caretOffset, extraWhitespaceAlreadyThere);
//        System.out.println("PunctuationCompletionItem:PunctuationCompletionItem(String, int) : begin");
//        System.out.println("PunctuationCompletionItem:PunctuationCompletionItem(String, int) : end");
    }
