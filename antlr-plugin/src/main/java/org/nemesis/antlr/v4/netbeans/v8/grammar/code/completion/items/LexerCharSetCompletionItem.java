 ...
 */
public class LexerCharSetCompletionItem  extends GrammarCompletionItem {
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
            ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
             "/lexerCharSetIcon.png"));
    protected static Color color = Color.decode("0x960096");
    
    
    public LexerCharSetCompletionItem
            (String  text                       ,
             int     insertionOffset            ,
             int     caretOffset                ,
             boolean extraWhitespaceAlreadyThere) {
        super(text, insertionOffset, caretOffset, extraWhitespaceAlreadyThere);
//        System.out.println("LexerCharSetCompletionItem:LexerCharSetCompletionItem(String, ...) : begin");
//        System.out.println("LexerCharSetCompletionItem:LexerCharSetCompletionItem(String, ...) : end");
    }
...
//        System.out.println("GrammarCompletionItem.getSortPriority() -> int : end");
        return SortOrder.LEXER_CHAR_SET;
    }
