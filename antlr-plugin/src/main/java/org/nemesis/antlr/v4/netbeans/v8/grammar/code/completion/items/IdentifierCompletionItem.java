 ...
 */
public class IdentifierCompletionItem extends GrammarCompletionItem {
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
          ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
           "/idIcon.png"));
    protected static Color color = Color.decode("0x990000");
    
    public IdentifierCompletionItem
            (String  text                       ,
             int     insertionOffset            ,
             int     caretOffset                ,
