 ...
 */
public class CommentCompletionItem extends GrammarCompletionItem {
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
          ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
           "/commentIcon.png"));
    protected static Color color = Color.decode("0x808080");
    
    
    public CommentCompletionItem
            (String  text           ,
             int     insertionOffset,
             int     caretOffset    ,
             boolean extraWhitespaceAlreadyThere) {
        super(text, insertionOffset, caretOffset, extraWhitespaceAlreadyThere);
//        System.out.println("CommentCompletionItem:CommentCompletionItem(String, int, int) : begin");
//        System.out.println("CommentCompletionItem:CommentCompletionItem(String, int, int) : end");
    }
