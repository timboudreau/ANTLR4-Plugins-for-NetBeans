 ...
 */
public class LexerRuleIdCompletionItem extends GrammarCompletionItem {
    protected static ImageIcon icon =
        new ImageIcon(ImageUtilities.loadImage
          ("org/nemesis/antlr/v4/netbeans/v8/grammar/code/completion/items" +
           "/lexerRuleIdIcon.png"));
    protected static Color color = Color.decode("0xcb9664");
    
    public LexerRuleIdCompletionItem
            (String  text                       ,
             int     insertionOffset            ,
             int     caretOffset                ,
...
//        System.out.println("GrammarCompletionItem.getSortPriority() -> int : end");
        return SortOrder.TOKEN_IDENTIFIER;
    }
