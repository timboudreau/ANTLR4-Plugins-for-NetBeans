...
import org.nemesis.antlr.v4.netbeans.v8.util.TimedCache.Expirable;
import org.nemesis.antlr.v4.netbeans.v8.util.TimedCache.Expirer;
...
public class TimedCacheTest {
    ...
    public void testCache() throws Throwable {
        ...
        EXPIRER.blockExpire();
        BidiCache<Integer, String, RuntimeException> cache = TimedCache.<Integer, String>create(60,
    ...
    public static void setup() {
        TimedCache.expirerFactory = () -> {return EXPIRER;};
    }
    ...
    static class TestExpirer extends Expirer {
        ...
        @Override
        void offer(TimedCache.Expirable expirable) {
