...
public final class EigenvectorCentrality extends RankingAlgorithm<EigenvectorCentrality> {
    ...
    @Override
    public EigenvectorCentrality setParameter(DoubleParameter param, double value) {
    ...
    @Override
    public EigenvectorCentrality setParameter(IntParameter param, int value) {
    ...
    @Override
    public EigenvectorCentrality setParameter(BooleanParameter param, boolean value) {
